...
import { playbackRate } from '@renderer/stores/player';
...
export const menuClass =
  'animate-out fade-out slide-out-to-bottom-2 data-[open]:animate-in data-[open]:fade-in data-[open]:slide-in-from-bottom-4 flex h-auto max-h-[400px] min-h-[200px] min-w-[260px] flex-col overflow-y-auto overscroll-y-contain rounded-md border border-white/10 bg-black/95 p-2.5 font-sans text-[15px] font-medium outline-none backdrop-blur-sm transition-[height] duration-300 will-change-[height] data-[resizing]:overflow-hidden';

export const submenuClass =
  'hidden w-full flex-col items-start justify-center outline-none data-[keyboard]:mt-[3px] data-[open]:inline-block min-h-20';
...
function PlaybackRateSubmenu() {
  ...
  const playbackRateStore = store.get(playbackRate)
  return (
    <Menu.Root>
      <SubmenuButton
        label="Playback Speed"
        hint={playbackRateStore.toString()}
        icon={Gauge}
      />
